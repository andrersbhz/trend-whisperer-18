...
-- Update encryption trigger to also encrypt gemini_api_key
...
-- Update get_credentials_status to include gemini key status
...
-- Revoke direct select on gemini_api_key
REVOKE SELECT (gemini_api_key) ON public.user_settings FROM authenticated, anon;