...
export const TRUSTED_SOURCES: Array<{
  ...
  { match: /correiobraziliense\.com\.br/i, name: "Correio Braziliense", type: "news", reliability: 0.85 },
  { match: /gazetadopovo\.com\.br/i, name: "Gazeta do Povo", type: "news", reliability: 0.82 },
  { match: /cartacapital\.com\.br/i, name: "CartaCapital", type: "news", reliability: 0.8 },
  { match: /jovempan\.com\.br/i, name: "Jovem Pan", type: "news", reliability: 0.78 },
  { match: /ig\.com\.br/i, name: "iG", type: "news", reliability: 0.78 },
  { match: /em\.com\.br/i, name: "Estado de Minas", type: "news", reliability: 0.82 },
  { match: /otempo\.com\.br/i, name: "O Tempo", type: "news", reliability: 0.8 },
  { match: /espn\.com\.br|lance\.com\.br/i, name: "Esporte (ESPN/Lance)", type: "news", reliability: 0.82 },
  { match: /cnnbrasil|cnn\.com/i, name: "CNN", type: "international", reliability: 0.88 },
