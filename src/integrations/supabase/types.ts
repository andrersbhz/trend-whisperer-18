  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "chip_groups"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "chat_messages_sender_chip_id_fkey"
            columns: ["sender_chip_id"]
            isOneToOne: false
            referencedRelation: "phone_chips"
            referencedColumns: ["id"]
          },
        ]
      }
      chip_group_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "chip_group_members_chip_id_fkey"
            columns: ["chip_id"]
            isOneToOne: false
            referencedRelation: "phone_chips"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "chip_group_members_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "chip_groups"
            referencedColumns: ["id"]
