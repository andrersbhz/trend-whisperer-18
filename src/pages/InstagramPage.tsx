            ...
            return (
              <Card key={idx} className="glass-card overflow-hidden">
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  {posts.length > 0 && (
                    <div>
                      <h3 className="text-2xl md:text-3xl uppercase font-black tracking-widest mb-4 flex items-center gap-3 text-[#39ff14]" style={{ textShadow: '0 0 8px #39ff14, 0 0 18px #39ff14, 0 0 32px rgba(57,255,20,0.6)' }}>
                  ...
                  {posts.length > 0 && (
                    <div>
                      <h3 className="text-2xl md:text-3xl uppercase font-black tracking-widest mb-4 flex items-center gap-3 text-[#ff2bd6]" style={{ textShadow: '0 0 8px #ff2bd6, 0 0 18px #ff2bd6, 0 0 32px rgba(255,43,214,0.6)' }}>
