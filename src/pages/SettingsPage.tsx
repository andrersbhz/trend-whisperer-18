  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="p-3 rounded-lg bg-accent/20 border border-accent/40 text-xs text-muted-foreground">
        <strong className="text-foreground">🔄 Sistema Multi-IA:</strong> O sistema tenta gerar artigos na seguinte ordem: <strong>Gemini → OpenAI → Groq → Lovable AI</strong>. Para imagens: <strong>Gemini → DALL-E 3 → Lovable AI</strong>. Se um provedor estiver sem saldo, o próximo é usado automaticamente.
      </div>
